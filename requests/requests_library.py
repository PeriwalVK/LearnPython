...
"""
Method signatures:
1. request.get(url, params=None, data=None, headers=None, cookies=None, files=None, auth=None, timeout=None, allow_redirects=True, proxies=None, hooks=None, stream=None, verify=None, cert=None, json=None)
2. request.post(url, data=None, json=None, headers=None, cookies=None, files=None, auth=None, timeout=None, allow_redirects=True, proxies=None, hooks=None, stream=None, verify=None, cert=None)
3. request.put(url, data=None, json=None, headers=None, cookies=None, files=None, auth=None, timeout=None, allow_redirects=True, proxies=None, hooks=None, stream=None, verify=None, cert=None)
4. request.patch(url, data=None, json=None, headers=None, cookies=None, files=None, auth=None, timeout=None, allow_redirects=True, proxies=None, hooks=None, stream=None, verify=None, cert=None)
5. request.delete(url, data=None, headers=None, cookies=None, auth=None, timeout=None, allow_redirects=True, proxies=None, hooks=None, stream=None, verify=None, cert=None)
...
response.history: list[Response]

response.content: bytes | Any

response.json(): Any

response.iter_lines(decode_unicode=True): Iterator[Incomplete]

response.raise_for_status(): None  # Raises HTTPError for 4xx/5xx
...
def post_with_json_data():
    ...
    response = requests.post(
        "https://httpbin.org/post", json=json_data
...
def basic_authentication():
    ...
    response = requests.get(
        "https://httpbin.org/basic-auth/grok/secret", auth=("grok", "secret")
    )
